...
int main()
{
 Employee Employee1("Michael ","Bubblee",3500); //declaring employee`s name1
 Employee Employee2("christine","aguero",5600); // declaring employees`s name2
